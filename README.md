...
| boldbi_v6.16.12_boldreports_v5.3.8 | November 03, 2023 | <img height="25" src='https://github.com/boldbi/bi_and_reports_azure-arm-template/blob/main/images/tick.png' />        | The following versions of Bold BI and Bold Reports are available on this branch. <br> * Bold BI **v6.16.12** released on **November 03, 2023**.<br> * Bold Reports **v5.3.8** released on **October 26, 2023**.|
