...
The instructions for deploying the new Bold BI and Bold Reports Azure App Service can be found [here](../bi_and_reports_azure-arm-template/deployment_guidelines.md).
