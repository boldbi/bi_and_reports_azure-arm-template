...
6.	[Click here](https://github.com/Anusha-Ramakrishna/bi_and_reports_azure-arm-template/blob/boldbi_v5.3.83_boldreports_v4.2.78/armtemplates/boldbi_v5.3.83_boldreports_v4.2.78/BoldServicesAppServiceTemplate.json) to download the ARM template file.
